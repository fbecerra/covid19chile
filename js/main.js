...
Promise.all([
    ...
    function filterData() {
      ...
      noteSource.html('* Base de datos del <a href="https://github.com/MinCiencia/Datos-COVID19" target="_blank">Ministerio de Ciencias</a> hasta el ' + dateFormat(dates[dates.length -1]))
